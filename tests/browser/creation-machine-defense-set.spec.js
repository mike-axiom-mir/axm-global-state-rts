...
test('explicit spotlight-tower alternate replaces only the real seat-1 light-tower fixture in four-seat LOCAL RTS', async ({ page }) => {
  ...
  expect(result.sourceAsset).toBe('spotlight-tower');
  ...
  await page.screenshot({ path: 'test-results/global-state-rts-creation-machine-spotlight-tower-4seat.png', fullPage: true });

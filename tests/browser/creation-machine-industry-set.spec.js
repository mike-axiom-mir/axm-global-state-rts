...
test('explicit machine-shop alternate replaces only the real seat-1 workshop fixture in four-seat LOCAL RTS', async ({ page }) => {
  ...
  expect(result.sourceAsset).toBe('machine-shop');
  ...
  await page.screenshot({ path: 'test-results/global-state-rts-creation-machine-machine-shop-4seat.png', fullPage: true });

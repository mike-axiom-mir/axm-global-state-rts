...
test('explicit Utility Hauler source trial attaches only to a real constructed LOCAL vehicle and stays seat-local', async ({ page }) => {
  ...
  expect(adopted.sourceAsset).toBe('utility-hauler');
  ...
  await page.screenshot({ path: 'test-results/global-state-rts-creation-machine-utility-hauler-4seat.png', fullPage: true });
